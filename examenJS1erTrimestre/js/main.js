...
function oscuro(){
    ...
    style.setAttribute("href", "css/blackstyle.css")
}
function claro(){
    style.setAttribute("href", "css/whitestyle.css")
}
...
function analizarContrasenia(){
    ...
    if(password.value === null || password.value === '' ){
        document.getElementById('mensajePasswordEmpty').innerHTML= ("No se ha ingresado contrasena. Por favor, ingrese una contrasena");
...
function reset(){ 
    ...
    Document.getElementById("cantLetrasIguales").innerHTML="";
    ...
    Document.getElementById("porcentajeNums").style.width="0px";
    Document.getElementById("porcentajeLetras").style.width="0px";
    Document.getElementById("porcentajeEspeciales").style.width="0px";
}
